...
const GlobalResult = () => {
  ...
  const [result, setResult] = useState([
    ...
    { type: "user", id: 1, title: "Romesh" },
    { type: "question", id: 1, title: "React question" },
  ]);
  ...
  useEffect(() => {
    const fetchResult = async () => {
      ...
      try {
        // fetch all result from the entire database
      } catch (error) {
        console.error(error);
        throw error;
      } finally {
        ...
        {isLoading ? (
          <div className="flex-center flex-col px-5">
            ...
            <p className="text-dark200_light800 body-regular">
              Hold tight! We&apos;re finding what you&apos;re looking for...
            </p>
          </div>
        ) : (
