...
export async function upvoteQuestion(params: QuestionVoteParams) {
  try {
    ...
    // increment author's reputation for upvoting, revoking an upvote to the question
    await User.findByIdAndUpdate(userId, {
      $inc: { reputation: hasupVoted ? -1 : 1 },
    });

    // increment author's reputation for receiving an upvote/downvote to the question
